	...
	<div class="container"><!--Start of container-->
		...
		<div class="row">
			<div class="span12">
				...
				<a id="login" class="btn btn-danger btn-small bottom pull-right" href="portal.php">
					Logout
				</a>
			</div>
		</div>
			...
			<div class="span12"><!--span12-->
				<div class="row"><!--start Row2-->
					...
					<div class="span9"><!--start span8-->
						<div id="tabs">
						  <ul>
						    <li><a href="#tabs-1">9/23/91</a></li>
						    <li><a href="#tabs-2">10/23/91</a></li>
						    <li><a href="#tabs-3">11/23/91</a></li>
						  </ul>
						  <div id="tabs-1">
						  
						  	<img src="http://lorempixel.com/150/150/technics/4/"/>
						  	<img src="http://lorempixel.com/150/150/technics/4/"/>	
						  	<img src="http://lorempixel.com/150/150/technics/4/"/>
						  	<img src="http://lorempixel.com/150/150/technics/4/"/>							  					  							  
